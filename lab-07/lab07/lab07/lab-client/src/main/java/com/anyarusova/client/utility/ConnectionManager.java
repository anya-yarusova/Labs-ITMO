...
public final class ConnectionManager {
    ...
    public CommandResultDTO sendCommand(CommandDTO commandDTO) throws DataCantBeSentException, UnresolvedAddressException {
        try (DatagramChannel datagramChannel = DatagramChannel.open()) {
            ...
            send(datagramChannel, commandDTO);
    ...
    private void send(DatagramChannel datagramChannel, CommandDTO commandDTO) throws IOException, DataCantBeSentException, UnresolvedAddressException {
        ...
        Pair<byte[], byte[]> pair = serialize(commandDTO);

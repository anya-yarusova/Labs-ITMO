...
public class OrganizationMaker {
    ...
    public Organization makeOrganization() throws IOException {
        return askForOrganization();
    }

    private Organization askForOrganization() throws IOException {
    ...
    private Address askForPostalAddress() throws IOException {
